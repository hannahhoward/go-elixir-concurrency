...
const AboutMeSlideAnna = ({ children }) => {
  const tgwLogo = require("../../assets/images/anna-headshot.jpg").replace(
    "/",
    ""
  );
  ...
  const climbingBishop = require("../../assets/images/climbing-bishop-small.jpg").replace("/", "");
  return (
    <FullScreen column>
      <Row style={{ flexShrink: 0 }}>
        <Heading size={1} fit caps lineHeight={1} textColor="quartenary">
          Anna Neyzberg #AboutMe
        </Heading>
      </Row>
      <Row>
        <Appear order={0}>
        ...
        <Appear order={2}>
          <Column>
            <Image src={climbingBishop} style={imageStyle} />
            <Text>Climbing rocks...</Text>
          </Column>
        </Appear>
      </Row>
      {children}
...
export default asSlide(AboutMeSlideAnna);
